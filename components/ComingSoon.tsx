const ComingSoon = () => {
  return (
    <section className='relative mt-20 flex min-h-[500px] w-full items-center justify-center overflow-hidden bg-black px-6'>
      {/* Background Glow */}
      <div className='absolute top-1/2 left-1/2 h-72 w-72 -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-600/10 blur-[100px]' />
      ...
      <div className='relative z-10 max-w-2xl text-center'>
        ...
        {/* Heading */}
        <h1 className='text-title text-4xl font-semibold tracking-tight sm:text-5xl md:text-6xl'>
          Coming
