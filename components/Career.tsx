...
import { AiAgentsIndustriesdata, AiExecutionServicesdata, aiInfrastructureData, aiInfrastructureSectionHead, aiRoadmapData, CareerFinalCtadata, diagnoseBeforeDeployData, heroData } from "@/app/career/data";
