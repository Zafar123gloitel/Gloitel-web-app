      ...
      <div className='relative z-10 mx-auto mt-20 w-full lg:w-7xl'>
        ...
        <div className='mt-8 flex flex-col justify-center gap-3 sm:flex-row'>
          ...
          <Link
            ...
            className='text-title inline-flex items-center justify-center gap-2 rounded-md border border-white/10 bg-white/10 px-5 py-3 text-sm font-medium transition hover:border-white/20 hover:bg-white/15'
          >
