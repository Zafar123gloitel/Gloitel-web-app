        ...
        <div className="relative overflow-hidden rounded-[2rem]">
          <div className="flex items-center justify-center gap-10 px-6 py-10 sm:px-10 lg:px-14 lg:py-14">
            <div className="relative z-10 max-w-2xl text-center">
              ...
              <h2 className="mt-7 text-4xl font-medium leading-[1.09] tracking-tight text-title sm:text-5xl lg:text-[3rem]">
                {title}
              </h2>

              <p className="mt-6 text-[16px] text-description xl:text-[20px] leading-7 text-t sm:text-base">
                {description}
              </p>
