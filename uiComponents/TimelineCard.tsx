    ...
    <div className='relative'>
      ...
      <div className='relative hidden h-[150px] grid-cols-[1fr_48px_1fr] items-center md:grid'>
        ...
        <div className='flex justify-end pr-24'>
          {side === 'left' && (
            <div className='relative'>
              {/* Dashed connector */}
              <div className='absolute top-1/2 left-full z-0 w-[125px] -translate-y-1/2 border-t border-dashed border-white/80' />
        ...
        <div className='flex justify-start pl-24'>
          {side === 'right' && (
            <div className='relative'>
              <div className='absolute top-1/2 right-full z-0 w-[125px] -translate-y-1/2 border-t border-dashed border-white/80' />
      ...
      <div className='relative flex min-h-[160px] items-center md:hidden'>
        ...
        <div className='relative z-10 flex-1 py-4'>
          <Card className='min-h-[125px] w-full'>
