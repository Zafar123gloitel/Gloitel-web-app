...
const BusinessCard = ({ key, icon, title, className }) => {
  return (
    <div key={key}>
      <div className="group relative w-[80%] mt-4 mx-auto overflow-hidden rounded-2xl p-[1px]">
        ...
        {/* Card */}
        <div className="relative flex h-full min-h-[66px] gap-5 items-center  rounded-2xl border border-white/10 bg-[#080B18] px-8  transition-all duration-300 group-hover:border-blue-500/30 group-hover:shadow-[0_0_35px_rgba(37,99,235,.18)]">
          <div
            className={[
              "relative",
