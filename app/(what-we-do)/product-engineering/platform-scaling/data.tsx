...
export const auditPhaseData = {
  ...
  buttonLink: '/',
  image:
    'https://res.cloudinary.com/dsqu6pi0d/image/upload/v1786712282/Gloitel/Product%20Engineering/Technical_Audit_ko3ec5.png',
...
export const roadmapPhaseData = {
  ...
  buttonLink: '/',
  image:
    'https://res.cloudinary.com/dsqu6pi0d/image/upload/v1786712282/Gloitel/Product%20Engineering/Prioritized_Roadmap_yxlgjv.png',
...
export const executionPhaseData = {
  ...
  buttonLink: '/',
  image:
    'https://res.cloudinary.com/dsqu6pi0d/image/upload/v1786712281/Gloitel/Product%20Engineering/Execution_aihpdn.png',
...
export const handoffPhaseData = {
  ...
  buttonLink: '/',
  image:
    'https://res.cloudinary.com/dsqu6pi0d/image/upload/v1786712281/Gloitel/Product%20Engineering/Handoff_Documentation_keykkd.png',
...
export const principlesData = [
  {
    ...
    title: "Fix the measurement problem first - you can't optimize what you can't observe",
  },
  {
    id: crypto.randomUUID?.() ?? Math.random().toString(36).slice(2),
  ...
  {
    id: crypto.randomUUID?.() ?? Math.random().toString(36).slice(2),
    icon: <ChartIcon size={25} className='' />,
    title: 'Migrate incrementally — big-bang rewrites have a terrible success rate',
  },
  {
    id: crypto.randomUUID?.() ?? Math.random().toString(36).slice(2),
    icon: <ShieldIcon size={25} className='' />,
    title:
      'Write the test before the fix - regression prevention, not just performance improvement',
  },
  {
    id: crypto.randomUUID?.() ?? Math.random().toString(36).slice(2),
    icon: <DocumentIcon size={25} className='' />,
...
export const scalingIndicators = [
  {
    id: crypto.randomUUID?.() ?? Math.random().toString(36).slice(2),
    icon: <AnomalyDetectionIcon size={25} className='' />,
...
export const scalingSolutions = [
  {
    id: crypto.randomUUID?.() ?? Math.random().toString(36).slice(2),
    icon: <RadarIcon size={25} className='' />,
  ...
  {
    id: crypto.randomUUID?.() ?? Math.random().toString(36).slice(2),
    icon: <DatabaseIcon size={25} className='' />,
  ...
  {
    id: crypto.randomUUID?.() ?? Math.random().toString(36).slice(2),
    icon: <CloudIcon size={25} className='' />,
  ...
  {
    id: crypto.randomUUID?.() ?? Math.random().toString(36).slice(2),
    icon: <WorkflowIcon1 size={25} className='' />,
  ...
  {
    id: crypto.randomUUID?.() ?? Math.random().toString(36).slice(2),
    icon: <CodeIcon size={25} className='' />,
    title: 'Caching LEngineering Process Improvementayer Design',
    description:
