...
export const discoverySprintData = {
  ...
  buttonLink: '/',
  image:
    'https://res.cloudinary.com/dsqu6pi0d/image/upload/v1787040167/Gloitel/Parent%20pages/Discovery_Sprint_a3cgki.png',
...
export const aiPilotData = {
  ...
  buttonLink: '/',
  image:
    'https://res.cloudinary.com/dsqu6pi0d/image/upload/v1787040166/Gloitel/Parent%20pages/AI_Pilot_n9iuoh.png',
  imageAlt: 'AI pilot',
};
...
export const productionScaleData = {
  ...
  buttonLink: '/',
  image:
    'https://res.cloudinary.com/dsqu6pi0d/image/upload/v1787040165/Gloitel/Parent%20pages/Production_Scale_r6mjmn.png',
