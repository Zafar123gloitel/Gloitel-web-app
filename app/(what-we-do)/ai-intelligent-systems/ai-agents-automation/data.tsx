...
export const aiAgentTechnologyData = {
  ...
  tabs: ['Frameworks', 'Tool Integration', 'Memory', 'Observability', 'Deployment'],
...
export const ApproachStepOne = {
  ...
  image:
    'https://res.cloudinary.com/dsqu6pi0d/image/upload/v1786613039/Gloitel/what%20we%20do/Process_Mapping_miouuy.png',
...
export const ApproachStepTwo = {
  ...
  image:
    'https://res.cloudinary.com/dsqu6pi0d/image/upload/v1786613039/Gloitel/what%20we%20do/Tool_Architecture_jc9cmw.png',
...
export const ApproachStepThree = {
  ...
  image:
    'https://res.cloudinary.com/dsqu6pi0d/image/upload/v1786613039/Gloitel/what%20we%20do/Failure_Mode_Analysis_acblok.png',
...
export const ApproachStepFour = {
  ...
  image:
    'https://res.cloudinary.com/dsqu6pi0d/image/upload/v1786613039/Gloitel/what%20we%20do/Pilot_with_Supervision_hd3xxx.png',
...
export const ApproachStepFive = {
  ...
  image:
    'https://res.cloudinary.com/dsqu6pi0d/image/upload/v1786613039/Gloitel/what%20we%20do/Gradual_Autonomy_ncejte.png',
