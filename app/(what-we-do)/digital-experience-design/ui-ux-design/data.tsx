...
export const uxDesignHeroData = {
  ...
  image: "https://res.cloudinary.com/dsqu6pi0d/image/upload/v1787033715/Gloitel/Digital%20Experience%20Design/UIUX_Design_uptvhe.png",
...
export const discoveryResearchData = {
  ...
  buttonLink: "/",
  image: "https://res.cloudinary.com/dsqu6pi0d/image/upload/v1787033714/Gloitel/Digital%20Experience%20Design/Discovery_Research_pmmyoq.png",
...
export const informationArchitectureData = {
  ...
  buttonText: "View more",
  buttonLink: "/",
  image: "https://res.cloudinary.com/dsqu6pi0d/image/upload/v1787033714/Gloitel/Digital%20Experience%20Design/Information_Architecture22_esdu1o.png",
...
export const wireframingData = {
  ...
  buttonText: "View more",
  buttonLink: "/",
  image: "https://res.cloudinary.com/dsqu6pi0d/image/upload/v1787033714/Gloitel/Digital%20Experience%20Design/Wireframing_yacqqs.png",
...
export const visualDesignData = {
  ...
  buttonText: "View more",
  buttonLink: "/",
  image: "https://res.cloudinary.com/dsqu6pi0d/image/upload/v1787033714/Gloitel/Digital%20Experience%20Design/Visual_Design_wvs0ee.png",
...
export const whatWeDesignData = [
  ...
  {
    id: crypto.randomUUID?.() ?? Math.random().toString(36).slice(2),
    image: "https://res.cloudinary.com/dsqu6pi0d/image/upload/v1787033713/Gloitel/Digital%20Experience%20Design/Mobile_Applications_oawhqm.png",
  ...
  {
    id: crypto.randomUUID?.() ?? Math.random().toString(36).slice(2),
    image: "https://res.cloudinary.com/dsqu6pi0d/image/upload/v1787033714/Gloitel/Digital%20Experience%20Design/Landing_Pages_Marketing_Sites_xne7l7.png",
  ...
  {
    id: crypto.randomUUID?.() ?? Math.random().toString(36).slice(2),
    image: "https://res.cloudinary.com/dsqu6pi0d/image/upload/v1787033713/Gloitel/Digital%20Experience%20Design/Onboarding_Flows_uxqycs.png",
  ...
  {
    id: crypto.randomUUID?.() ?? Math.random().toString(36).slice(2),
    image: "https://res.cloudinary.com/dsqu6pi0d/image/upload/v1787033713/Gloitel/Digital%20Experience%20Design/Data_Dashboards_ilx9us.png",
