...
export const instrumentMeasureData = {
  ...
  description: "Establish baseline metrics. If you can't measure it, you can't improve it.",
  buttonText: 'View more',
  buttonLink: '/',
  image:
    'https://res.cloudinary.com/dsqu6pi0d/image/upload/v1787033712/Gloitel/Digital%20Experience%20Design/Instrument_Measure_j0em8s.png',
...
export const identifyOpportunitiesData = {
  ...
  buttonLink: '/',
  image:
    'https://res.cloudinary.com/dsqu6pi0d/image/upload/v1787033712/Gloitel/Digital%20Experience%20Design/Identify_Opportunities_kpmegd.png',
...
export const hypothesizeData = {
  ...
  buttonLink: '/',
  image:
    'https://res.cloudinary.com/dsqu6pi0d/image/upload/v1787033712/Gloitel/Digital%20Experience%20Design/Hypothesize_wrljav.png',
...
export const designTestData = {
  badgeText: 'Step 04',
  title: 'Design & Test',
  description: 'Design the change, implement the test, collect data with statistical significance.',
  buttonText: 'View more',
  buttonLink: '/',
  image:
    'https://res.cloudinary.com/dsqu6pi0d/image/upload/v1787033712/Gloitel/Digital%20Experience%20Design/Design_Test_mzb6n0.png',
...
export const implementMonitorData = {
  ...
  description: 'Roll out winning variations. Monitor for regressions. Document learnings.',
  buttonText: 'View more',
  buttonLink: '/',
  image:
    'https://res.cloudinary.com/dsqu6pi0d/image/upload/v1787033712/Gloitel/Digital%20Experience%20Design/Implement_Monitor_dpvljf.png',
