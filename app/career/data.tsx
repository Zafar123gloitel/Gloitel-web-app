  ...
  services: [
    {
      ...
      list: ['Internship', 'On-site/ Hybrid', 'Exp/Our'],
...
export const aiInfrastructureData: ArchitectureItem[] = [
  {
    ...
    description: 'Choose the right models and capabilities for your workload.',
  },

  {
    ...
    icon: (
      ...
      >
        ...
        <circle cx='29' cy='10' r='3' stroke='white' strokeWidth='2' />
        <circle cx='7' cy='27' r='3' stroke='white' strokeWidth='2' />
        <circle cx='29' cy='27' r='3' stroke='white' strokeWidth='2' />
        <path d='M10 11L14.5 15' stroke='white' strokeWidth='2' strokeLinecap='round' />
        <path d='M26 11L21.5 15' stroke='white' strokeWidth='2' strokeLinecap='round' />
        <path d='M10 26L14.5 21' stroke='white' strokeWidth='2' strokeLinecap='round' />
        <path d='M26 26L21.5 21' stroke='white' strokeWidth='2' strokeLinecap='round' />
      </svg>
    ),
    title: 'Orchestration',
    description: 'Coordinate AI agents, tools, workflows, and services.',
  },

  {
    ...
    icon: (
      <svg
        ...
        fill='none'
      >
        <ellipse cx='18' cy='8' rx='10' ry='4' stroke='white' strokeWidth='2' />
        <path
    ...
    title: 'Data & Context',
    description: 'Connect your AI systems with trusted business data and context.',
  },

  {
    ...
    icon: (
      <svg
        ...
        fill='none'
      >
        <path d='M6 25V18' stroke='white' strokeWidth='2' strokeLinecap='round' />
        <path d='M12 25V13' stroke='white' strokeWidth='2' strokeLinecap='round' />
        <path d='M18 25V9' stroke='white' strokeWidth='2' strokeLinecap='round' />
        <path d='M24 25V16' stroke='white' strokeWidth='2' strokeLinecap='round' />
        <path d='M30 25V6' stroke='white' strokeWidth='2' strokeLinecap='round' />
        <path d='M5 30H31' stroke='white' strokeWidth='2' strokeLinecap='round' />
      </svg>
    ),
    title: 'Monitoring',
    description: 'Track performance, reliability, usage, and system behavior.',
  },

  {
    ...
    title: 'Scalability',
    description: 'Design systems that can scale with users, data, and workloads.',
  },

  {
    ...
    icon: (
      <svg
        ...
        fill='none'
      >
        <rect x='5' y='6' width='10' height='10' rx='2' stroke='white' strokeWidth='2' />
        <rect x='21' y='6' width='10' height='10' rx='2' stroke='white' strokeWidth='2' />
        <rect x='13' y='20' width='10' height='10' rx='2' stroke='white' strokeWidth='2' />
        <path d='M15 11H21' stroke='white' strokeWidth='2' />
        <path d='M26 16V20' stroke='white' strokeWidth='2' />
        <path d='M10 16V24H13' stroke='white' strokeWidth='2' />
      </svg>
    ),
    title: 'Integration',
    description: 'Connect AI capabilities with your existing technology stack.',
  },
];
