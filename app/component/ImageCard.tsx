  ...
  return (
    <div>
      ...
      <Card className={cradClass }>
        <div>
          <div className=" ">
            <div className="flex items-center justify-center bg-none w-full h-[295.47px] rounded-2xl mb-3">
        ...
        <Link
          href={buttonurl}
          className="flex gap-2 pb-3 pt-2 absolute bottom-1.5 left-5 text-base text-title group-hover:text-blue-600 items-center  "
        >
          {buttintext}
