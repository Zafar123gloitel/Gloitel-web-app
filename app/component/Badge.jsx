...
export const LeftBadge = ({
  ...
  return (
    <div className="relative w-fit text-center backdrop-blur-md bg-gray-900/50 px-4 py-2 rounded-md shadow-lg mb-6 overflow-hidden border-2 border-gray-600/20">
      {/* Top Blue Glow */}
      ...
      <h2 className="text-xs sm:text-sm text-white font-medium relative z-10">
