...
export const resourceCategoriesData: HeroCard[] = [
  {
    id: crypto.randomUUID?.() ?? Math.random().toString(36).slice(2), position: "top-left",
    icon: '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></svg>', title: "Blogs & Articles"
  },
  {
    id: crypto.randomUUID?.() ?? Math.random().toString(36).slice(2), position: "top-right",
    icon: '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M12 3v18"/><path d="M3 12h18"/></svg>', title: "Guides & Tutorials"
  },
  {
    id: crypto.randomUUID?.() ?? Math.random().toString(36).slice(2), position: "bottom-left",
    icon: '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18"/><path d="m7 16 4-5 3 3 5-7"/></svg>', title: "Case Studies"
  },
  {
    id: crypto.randomUUID?.() ?? Math.random().toString(36).slice(2), position: "bottom-right",
    icon: '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3v18"/><path d="M3 12h18"/><path d="m5 5 14 14"/><path d="m19 5-14 14"/></svg>', title: "Whitepapers & eBooks"
  },
];
...
export const integrationStabilityData = [
  { id: crypto.randomUUID?.() ?? Math.random().toString(36).slice(2), title: "Integration Stability", description: "AI systems often fail not because the model is but because the surrounding integrations are unreliable. We build stable connections between AI.", buttonText: "View Case Study", buttonLink: "#" },
  { id: crypto.randomUUID?.() ?? Math.random().toString(36).slice(2), title: "Integration Stability", description: "AI systems often fail not because the model is but because the surrounding integrations are unreliable. We build stable connections between AI.", buttonText: "View Case Study", buttonLink: "#" },
  { id: crypto.randomUUID?.() ?? Math.random().toString(36).slice(2), title: "Integration Stability", description: "AI systems often fail not because the model is but because the surrounding integrations are unreliable. We build stable connections between AI.", buttonText: "View Case Study", buttonLink: "#" },
  { id: crypto.randomUUID?.() ?? Math.random().toString(36).slice(2), title: "Integration Stability", description: "AI systems often fail not because the model is but because the surrounding integrations are unreliable. We build stable connections between AI.", buttonText: "View Case Study", buttonLink: "#" },
  { id: crypto.randomUUID?.() ?? Math.random().toString(36).slice(2), title: "Integration Stability", description: "AI systems often fail not because the model is but because the surrounding integrations are unreliable. We build stable connections between AI.", buttonText: "View Case Study", buttonLink: "#" },
...
export const resourceCaseStudiesData = [
  ...
  },
  {
    ...
    title: "E-Commerce",
    description:
      "LLM-powered product description output. Human review time minutes per batch.",
    buttonText: "View Case Study",
