...
export const weekOneData = {
  ...
  buttonLink: '#',
  image:
    'https://res.cloudinary.com/dsqu6pi0d/image/upload/v1786712283/Gloitel/Product%20Engineering/Setup_Architecture_sieo3b.png',
...
export const weekTwoData = {
  ...
  buttonLink: '#',
  image:
    'https://res.cloudinary.com/dsqu6pi0d/image/upload/v1786712282/Gloitel/Product%20Engineering/Core_Build_quiwdw.png',
  imageAlt: 'Core Build',
};
...
export const weekThreeData = {
  ...
  buttonLink: '#',
  image:
    'https://res.cloudinary.com/dsqu6pi0d/image/upload/v1786712282/Gloitel/Product%20Engineering/Hardening_Launch_Prep_dkomfv.png',
...
export const weekFourData = {
  ...
  buttonLink: '#',
  image:
    'https://res.cloudinary.com/dsqu6pi0d/image/upload/v1786712282/Gloitel/Product%20Engineering/Measure_Iterate_keay83.png',
